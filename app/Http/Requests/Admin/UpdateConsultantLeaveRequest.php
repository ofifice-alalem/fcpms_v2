...
class UpdateConsultantLeaveRequest extends FormRequest
{
    ...
    {
        return [
            'consultant_id.required' => 'حقل الاستشاري مطلوب.',
            'consultant_id.exists' => 'الاستشاري المحدد غير موجود بالنظام.',
