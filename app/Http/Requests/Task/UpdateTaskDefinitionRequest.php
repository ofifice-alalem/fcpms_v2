...
class UpdateTaskDefinitionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'components.*.options.*.id' => ['nullable'],
            'components.*.options.*.label' => ['nullable', 'string'],
            'components.*.options.*.value' => ['nullable', 'string'],
            'components.*.options.*.option_label' => ['nullable', 'string'],
            'components.*.options.*.option_value' => ['nullable', 'string'],
